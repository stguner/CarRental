...
<section class="gradient-custom">
 <?php /*Başarılı kayıt */ if ($_GET['durum']=="basarili_contact") {?>
              <div class="alert alert-success text-center">
                <strong>Your message is taken!</strong> We will contact you as soon as possible.
              </div>
              <?php }?>
              <?php /*Kullanıcı Bulunamadı */if ($_GET['durum']=="basarisiz_contact") {?>
      ...
      <div class="col-md-6">
        <div class="card container shadow bg-dark mt-4">
          ...
          <form method="POST" action="islem.php">
            ...
            <!-- Form submit button -->
            <div class="d-grid">
              <button class="btn btn-primary mb-2 mt-2" id="submitButton" name="contact" type="submit">Submit</button>
            </div>
