...
?>
    <?php /*Başarılı kayıt */ if ($_GET['durum']=="rezervasyon_islem_tamamlandi") {?>
      <div class="alert alert-success text-center">
        <strong >Your reservation done successfully.</strong> Enjoy your ride. You can track your reservations <a href="user_reservations.php?durum=ok&rezervasyon_sil=waiting" 
        class="font-weight-bold text-success">HERE</a>.
        </div>
    <?php }?>
    <?php /*Başarılı kayıt */ if ($_GET['durum']=="rezervasyon_islem_tamamlanamadi") {?>
      <div class="alert alert-success text-center">
        <strong>ERROR!</strong> Please contact the admin.
        </div>
    <?php }?>
<!-- Carousel başlangıç-->
